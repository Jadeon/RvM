...
{
    public class BreadthFirstAttack
    {
        ...
        public BreadthFirstAttack(State state, Unit activeUnit)
        {
            Tile start = activeUnit.Position;
            ...
            while (frontier.Count > 0) 
            {
                ...
                if (Heuristic(start, current) < activeUnit.Abilities[0].Range)
                {
